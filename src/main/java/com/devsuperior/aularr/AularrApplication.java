...
public class AularrApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		u1.getFollowing().addAll(Arrays.asList(u3,u2));
		u2.getFollowing().addAll(Arrays.asList(u1,u4));
		u3.getFollowing().addAll(Arrays.asList(u1,u2,u5));
		u4.getFollowing().addAll(Arrays.asList(u1,u2));
		u5.getFollowing().addAll(Arrays.asList(u3,u4));
